...
const uint16_t CUBE_OPEN_LO   = 1700, CUBE_OPEN_HI   = 2600;
const uint16_t CUBE_LISTEN_LO = 2700, CUBE_LISTEN_HI = 4300;
...
void updateRing() {
  ...
  // Brightness goes straight into the colour. Not ring.setBrightness():
  // that rescales the stored pixels and loses them (setBrightness(0) = dark forever).
  ring.fill(ring.Color(brightness, brightness, brightness));
  ring.show();
}
